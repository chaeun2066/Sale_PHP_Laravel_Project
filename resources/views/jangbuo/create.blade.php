...
@section('content')
  ...
  <!-- 사용자 정보 입력 -->
  <form action="{{ route('jangbuo.store') }}{{$tmp}}" name="form1" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <table class="table table-sm table-bordered mymargin5">
      ...
      <tr>
        ...
        <td width="80%" style="text-align: left;">
          <div class="d-inline-flex">
            ...
            <input type="text" name="product_name" value="" class="form-control from-control-sm" readonly>&nbsp;
      ...
      <tr>
        ...
        <td width="80%" style="text-align: left;">
          <div class="d-inline-flex">
            <input type="text" name="price" size="20" value="{{ old('price') }}" class="form-control form-control-sm" onchange="cal_prices();">
          </div>
        </td>
      </tr>
      <tr>
